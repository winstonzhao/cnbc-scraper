...
var DbController = /** @class */ (function () {
    ...
    DbController.prototype.init = function () {
    ...
    DbController.prototype.disconnect = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.GetDbController = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!dbController.initiated) return [3 /*break*/, 2];
                return [4 /*yield*/, dbController.init()];
            case 1:
                _a.sent();
                _a.label = 2;
            case 2: return [2 /*return*/, dbController];
        }
    });
}); };
